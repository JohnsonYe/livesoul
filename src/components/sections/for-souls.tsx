  ...
  return (
    <section id="for-souls" className="relative overflow-hidden bg-cream py-24 md:py-32">
      ...
      <div className="relative max-w-4xl mx-auto px-6">
        ...
        <a
          href="#sign"
          className="inline-block bg-charcoal text-cream font-sans font-semibold text-sm tracking-wide px-8 py-4 transition-opacity duration-200 hover:opacity-75"
        >
